...
return [
    ...
    'tailwind' => [
        ...
        'button' => ['+class' => 'inline py-2 px-4 text-sm leading-5 font-medium rounded-md focus:outline-none focus:shadow-outline-blue transition duration-150 ease-in-out',
            'font-color' => false],
        'button-primary' => ['+class' => 'text-white active:bg-indigo-600 bg-indigo-600 hover:bg-indigo-500'],
        'button-secondary' => ['+class' => 'text-gray-700 border hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 border-gray-300'],
        ...
        'dropdown' => ['toggle' => true, 'group_class' => 'relative inline-block', 'template' => 'flatform::tailwind.dropdown', ],
        ...
        'tabs' => ['type' => 'div', 'class' => '', ],
        'tabs-nav' => ['type' => 'ul', 'class' => 'flex'],
        'tab-item' => ['type' => 'li', 'template' => 'flatform::tailwind.tab-item'],
        'tabs-content' => ['type' => 'div', 'class' => 'p-4 border-l border-r border-b border-gray-200 rounded-b-md'],
    ],
