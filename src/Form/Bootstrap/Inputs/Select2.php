...
class Select2 extends Input
{
    ...
    protected function renderOptions()
    {
        ...
        if(!is_null($this->list)) {
            foreach($this->list as $key => $value){
                ...
                $html .= $this->renderer()->renderArray($option, 'option', $value);
            }
            ...
            if(is_countable($selected)) {
                ...
                $html .= $this->renderer()->renderArray($option, 'option', $selected->name ?? $selected->title);
            }
        }
        return $html;
    }
    ...
    public function render()
    {
        ...
        return $html .
            $this->renderer()->renderArray($options, 'select', $this->renderOptions());
